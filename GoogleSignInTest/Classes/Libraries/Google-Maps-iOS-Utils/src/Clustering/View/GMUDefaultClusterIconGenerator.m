...
+ (void)initialize {
  kGMUBucketBackgroundColors = @[
    ...
    [UIColor colorWithRed:40 / 255.0 green:53 / 235.0 blue:147 / 255.0 alpha:1.0],
    [UIColor colorWithRed:14 / 255.0 green:78 / 235.0 blue:64 / 255.0 alpha:1.0]
  ];
}
...
- (UIImage *)iconForText:(NSString *)text withBaseImage:(UIImage *)image {
  ...
  paragraphStyle.alignment = NSTextAlignmentCenter;
    UIColor *textColor = [UIColor colorWithRed: 33 / 255.0 green: 33 / 255.0 blue: 33 /255.0 alpha: 1.0];
...
+ (NSArray *)customBackgroundImages { // return 5 items
    UIImage *img1 = [UIImage imageNamed:@"clusterIcon1"];
    NSArray *bgImgArray = @[img1, img1, img1, img1, img1];
    return bgImgArray;
}
